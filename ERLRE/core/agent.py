...
from . import replay_memory
from ERLRe2.parameters import Parameters
import torch
from . import utils
import scipy.signal
...
class Agent:
    ...
    def train_ddpg(self, evo_times,all_fitness, state_list_list,reward_list_list, policy_params_list_list,action_list_list):
        ...
        if len(self.replay_buffer.storage) >= 500:#self.args.batch_size * 5:
    ...
    def train(self):
        ...
        action_list_list =[]
        print("self.args.EA:"+(str)(self.args.EA))
        print("self.rl_agent_frames:"+(str)(self.rl_agent_frames))
        print("self.args.init_steps:"+(str)(self.args.init_steps))
            ...
            if random_num_num< self.args.theta:
                for i, net in enumerate(self.pop):
                    for j in range(self.args.num_evals):
                        print("population: "+ i + " ;num_evals: "+"j")
